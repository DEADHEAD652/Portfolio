        ...
        <div className="flex justify-center items-center">
          <form ref={form} onSubmit={sendEmail} className="flex flex-col w-full md:w-1/2">
            <input
              ...
              className="p-2 transparent border-2 rounded-md text-white focus:outline-none bg-transparent"
            />
            <input
              type="email"
              name="email"
              placeholder="Enter your email"
              className="my-4 p-2 transparent border-2 rounded-md text-white focus:outline-none bg-transparent"
            />
            <textarea
              name="message "
